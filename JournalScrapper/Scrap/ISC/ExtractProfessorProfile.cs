...
//    public static async Task ScrapProfessor()
//    {
//        var _context = new DynamicDbContext();
//        //var a = _context.Professors.Select(x => new { ProfileShakhsiEn = "http://93.126.41.157:82/en/" + x.FullName.Replace(" ", "-"), ProfileShakhsiFa = "http://93.126.41.157:82/fa/" + x.FullName.Replace(" ", "-") + "", ElmSanji = "http://93.126.41.157:85/" + x.FullName.Replace(" ", "-") + "" });
...
//                //        .FirstOrDefault(d => d.TitleFa == departmentName);
...
//                //    continue;
//                //var exist = await _context.Professors.AnyAsync(x => x.FullNameEn.Equals(professor.FullNameEn));
//                //if (exist)
//                //    continue;
...
//                professor.Books = new List<Book>();

//                foreach (var article in professor.Articles)
//                {
//                    if (foundBooks)
//                    {
//                        // اضافه کردن آیتم‌ها به لیست Books پس از پیدا شدن "Books"
//                        professor.Books.Add(new Book
//                        {
//                            Title = article.Title,
...
//                    if (article.Title.Contains("Book") && article.Title.Split(" ").Length < 5)
//                    {
//                        // شروع اضافه کردن از آیتم بعدی
//                        foundBooks = true;
//                    }
//                }

//                // حذف آیتم‌های مربوط به Books از Articles
//                professor.Articles = professor.Articles.TakeWhile(article => !article.TitleEn.Contains("Book") && article.Title.Split(" ").Length < 5).ToList();
//                await _context.Books.AddRangeAsync(professor.Books);
//                await _context.Articles.AddRangeAsync(professor.Articles);
...
//                    .Select(x => new ProfessionalActivity { Title = x.Text, ProfessorId = professor.Id }).ToList();
//                await _context.ProfessionalActivities.AddRangeAsync(professor.ProfessionalActivities ?? new List<ProfessionalActivity>());
...
//            if (title.ToLower().Trim().Equals("scholarly articles"))
//                continue;
...
//        }
//    }
//    private class collectionProfile
//    {
//        public string Title { get; set; }
//        public string Link { get; set; }
//    }
//    private static WebLink ScrapeWebLinks(int professorId)
//    {
//        var link = new WebLink()
//        {
//            ProfessorId = professorId
//        };
//        var webLinkElements = GetElements(By.XPath("//dd[@class='web-links']/a")).Select(element => new collectionProfile
//        {
//            Title = element.Text,
//            Link = element.GetAttribute("href")
//        }).ToList();
//        var linksElement = GetElement(By.XPath("//h4[contains(text(), 'Links')]"));
//        var links = GetElements(linksElement,
//            By.XPath("..//..//a"))?
...
//    private static List<Education> ScrapeEducations(int professorId)
//    {
...
//    private static ICollection<Article> ScrapeArticles(int professorId)
//    {
...
//            {
//                TitleEn = element.Text,
//                IscArticleId = element.GetAttribute("href"),
//                //ProfessorId = professorId
//            });
//        }
//        return articles;
