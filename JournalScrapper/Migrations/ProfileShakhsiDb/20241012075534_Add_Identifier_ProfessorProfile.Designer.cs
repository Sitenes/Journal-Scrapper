...
namespace JournalScrapper.Migrations.ProfileShakhsiDb
{
    ...
    [Migration("20241012075534_Add_Identifier_ProfessorProfile")]
    partial class Add_Identifier_ProfessorProfile
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Profile_Shakhsi.Models.Entity.Profile+Department", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Profile_Shakhsi.Models.Entity.Profile+Faculty", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Profile_Shakhsi.Models.Entity.Profile+Faculty", b =>
                {
                    b.HasOne("Profile_Shakhsi.Models.Entity.Profile+Department", "Department")
                        .WithMany()
            ...
            modelBuilder.Entity("Profile_Shakhsi.Models.Entity.Profile+ProfessorProfile", b =>
                {
                    b.HasOne("Profile_Shakhsi.Models.Entity.Profile+Faculty", "Faculty")
                        .WithMany()
